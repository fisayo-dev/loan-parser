...
const Landing = () => {
  return (
    <div className="">
      <div className="grid place-items-center h-auto lg:h-full">
        <div className="2xl:py-20 py-10 flex flex-col items-center justify-center text-center">
          <div className="flex flex-col">
            <h2 className="lg:leading-20 text-4xl lg:text-7xl font-bold">
          ...
          <Button text="Start for free" className="lg:text-2xl px-10" />
        </div>
      </div>
    </div>
  );
